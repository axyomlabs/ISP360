...
function Header({ toggleSidebar, isSidebarOpen }) {
  ...
  return (
    <>
      <div
        className="main-header p-3 bg-white d-flex flex-column flex-md-row justify-content-between align-items-center"
        id="header"
      >
        ...
        <div className="header-section header-search-wrapper flex-grow-1 order-md-2 my-2 my-md-0 d-flex align-items-center">
          ...
          >
            <span style={{ fontSize: "2rem", fontWeight: "bold" }}>ISP</span>
          </div>
      ...
      {/* Breadcrumb component added here */}
      <div className="breadcrumb-wrapper bg-white border-bottom">
        <Breadcrumb>
