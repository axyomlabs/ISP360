...
import { Modal, Button, Form } from "react-bootstrap"; // Add Form to imports
      ...
      <Modal.Body>
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-center">
          ...
          <div className="d-flex flex-row flex-md-column justify-content-center align-items-center my-3 my-md-0">
            <Button
              className="mb-md-2 me-2 me-md-0 modal-button-transform"
            ...
            <Button
              className="modal-button-transform"
