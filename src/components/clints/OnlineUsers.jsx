...
// Import the reusable table and the pagination component
import SubscriberTable from "../../components/SubscriberTable.jsx"; 
import TablePagination from "../../components/TablePagination.jsx"; 

// --- ONLINE USERS SAMPLE DATA ---
// Data structure aligned with previous user request for columns
const onlineUsersSampleData = [
    ...
    // Adding a few more entries for realistic pagination
    ...
    // A few more entries to show pagination pages
...
function OnlineUsers() {
    ...
    // State for rows per page, starts at 10 or a default option
    const [itemsPerPage, setItemsPerPage] = useState(10); 
    const [visibleColumns, setVisibleColumns] = useState(initialOnlineColumns);
    
    // NOTE: This assumes there are no active filters beyond what's on the page
    const filteredData = onlineUsersSampleData; // In a real app, this would be filtered
    const totalResults = filteredData.length; 
    const totalPages = Math.ceil(totalResults / itemsPerPage);

    // Calculate indices for pagination and summary display
    ...
    const subscribersToShow = useMemo(() => {
        ...
        // Map the source data's 'conn' key to 'connStatus' which SubscriberTable expects
        return currentData.map(user => ({
            ...user,
            connStatus: user.conn, // CRITICAL MAPPING for Live Graph icon
            id: String(user.id), // Ensure ID is string for consistency
        }));
        ...
        <div className="container-fluid">
            ...
            <div className="card shadow-sm mt-1 p-3 mx-2" style={{ maxWidth: '100%' }}> 
                ...
                <div className="card-body">
                    {/* Filter Inputs Row (as per your previous layout) */}
            ...
            {/* ==================================================================== */}
            {/* PAGINATION SUMMARY AND ROWS PER PAGE CONTROL (Matching AllSubscribers) */}
            {/* ==================================================================== */}
            <div
            ...
            <div className="card m-1" style={{ height: "63vh", overflow: "hidden" }}>
                ...
                {/* Pagination Controls (Using TablePagination component) */}
                <div className="mx-2">
                    <TablePagination
